...
// transfer optimistic unchoked ids for the process or class which manages unchoking mechanism
    ...
    synchronized void addThisPart(int peerId, int size) {
    ...
    {
        if(interestedPeers.size()>Integer.parseInt(peerProcess.common_cfg.getProperty("NumberOfPreferredNeighbors"))){
...
//return peers to choke
    ...
    */
    ...
    /*
       ...
       */
    public synchronized PeerInfo searchForPeer(int peerID)
    {
